    ...
    if (td_0 && td_1) {
      ...
      if (txtValue_0.toUpperCase().indexOf(filter) > -1) {
        if (option_brand.value == "All") {
          tr[i].style.display = "";
        } else if (option_brand.value == "Biostar" && txtValue_1 == "Biostar") {
          tr[i].style.display = "";
        } else if (option_brand.value == "ASUS" && txtValue_1 == "ASUS") {
          tr[i].style.display = "";
        }
      } else {
  ...
  if (option_brand.value == "Biostar") {
    for (i = 0; i < tr.length; i++) {
      ...
      if (td_0 && td_1) {
        txtValue_0 = td_0.textContent || td_0.innerText;
        txtValue_1 = td_1.textContent || td_1.innerText;
        if (txtValue_1 == "Biostar" && txtValue_0.toUpperCase().indexOf(filter) > -1) {
          tr[i].style.display = "";
        } else {
          tr[i].style.display = "none";
        }
  ...
  if (option_brand.value == "ASUS") {
    for (i = 0; i < tr.length; i++) {
      ...
      if (td_0 && td_1) {
        txtValue_0 = td_0.textContent || td_0.innerText;
        txtValue_1 = td_1.textContent || td_1.innerText;
        if (txtValue_1 == "ASUS" && txtValue_0.toUpperCase().indexOf(filter) > -1) {
          tr[i].style.display = "";
        } else {
          tr[i].style.display = "none";
        }
